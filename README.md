...
Still the same idea, with [RFC8998](https://datatracker.ietf.org/doc/html/rfc8998) `TLS1.3_SM4_GCM_SM3` as cipher suite / `SM2` as KeyShare curve hardcoded as suggested [here](https://github.com/net4people/bbs/issues/129#issuecomment-1272289638). 
