// Source: https://github.com/tokio-rs/tokio/blob/master/tokio/src/io/util/copy.rs
        ...
        W: AsyncWrite + ?Sized,
    {
        ...
        loop {
            ...
            if self.cap < self.buf.len() && !self.read_done {
                match self.poll_fill_buf(cx, reader.as_mut()) {
                    ...
                    Poll::Ready(Err(err)) => {
                        ...
                        // ))]
                        // coop.made_progress();
                        return Poll::Ready(Err(CopyError::read(err)));
                    }
                    Poll::Pending => {
                        ...
                        if self.pos == self.cap {
                            ...
                            if self.need_flush {
                                ready!(writer.as_mut().poll_flush(cx).map_err(CopyError::write))?;
                                // #[cfg(any(
                                //     feature = "fs",
                                //     feature = "io-std",
                                //     feature = "net",
            ...
            while self.pos < self.cap {
                let i = ready!(self
                    .poll_write_buf(cx, reader.as_mut(), writer.as_mut())
                ...
                // coop.made_progress();
                if i == 0 {
                    return Poll::Ready(Err(CopyError::write(io::Error::new(
