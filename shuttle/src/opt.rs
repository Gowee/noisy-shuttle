// use ja3_rustls::{ConcatenatedParser};
...
#[structopt(name = "noisy-shuttle", about = "Shuttle for the Internet (RFC8998 edition)", global_settings(&[ColoredHelp, DeriveDisplayOrder]))]
pub struct Opt {
    #[structopt(flatten)]
